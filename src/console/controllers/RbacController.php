...
use common\components\rbac\UserActiveRule;
...
class RbacController extends Controller
{
    ...
    public function init()
    {
        self::$permissions = [
            ...
            User::ROLE_USER => [
                'frontend.account',
                Comment::RBAC_FRONTEND_ALL,
                Comment::RBAC_FRONTEND_CREATE => UserActiveRule::class,
                Comment::RBAC_FRONTEND_UPDATE => UserOwnerRule::class,
            ],
