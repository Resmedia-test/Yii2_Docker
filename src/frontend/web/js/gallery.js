 ...
 */
galleryVersion = "4.6.4", function (a, b, c, d, e) {
    "use strict";
    function f(a) {
    ...
    function B(a, b, c) {
        var e, f, g = a.video;
        return "youtube" === g.type ? (f = y() + "img.youtube.com/vi/" + g.id + "/default.jpg", e = f.replace(/\/default.jpg$/, "/mqdefault.jpg"), a.thumbsReady = !0) : "vimeo" === g.type ? d.ajax({
    ...
    function fb() {
        d.each(d.Gallery.instances, function (a, b) {
            b.index = a
        })
    }

    function gb(a) {
        d.Gallery.instances.push(a), fb()
    }

    function hb(a) {
        d.Gallery.instances.splice(a.index, 1), fb()
    }

    var ib = "gallery", jb = "fullscreen", kb = ib + "__wrap", lb = kb + "--css2", mb = kb + "--css3", nb = kb + "--video", ob = kb + "--fade", pb = kb + "--slide", qb = kb + "--no-controls", rb = kb + "--no-shadows", sb = kb + "--pan-y", tb = kb + "--rtl", ub = kb + "--only-active", vb = kb + "--no-captions", wb = kb + "--toggle-arrows", xb = ib + "__stage", yb = xb + "__frame", zb = yb + "--video", Ab = xb + "__shaft", Bb = ib + "__grab", Cb = ib + "__pointer", Db = ib + "__arr", Eb = Db + "--disabled", Fb = Db + "--prev", Gb = Db + "--next", Hb = ib + "__nav", Ib = Hb + "-wrap", Jb = Hb + "__shaft", Kb = Hb + "--dots", Lb = Hb + "--thumbs", Mb = Hb + "__frame", Nb = Mb + "--dot", Ob = Mb + "--thumb", Pb = ib + "__fade", Qb = Pb + "-front", Rb = Pb + "-rear", Sb = ib + "__shadow", Tb = Sb + "s", Ub = Tb + "--left", Vb = Tb + "--right", Wb = ib + "__active", Xb = ib + "__select", Yb = ib + "--hidden", Zb = ib + "--fullscreen", $b = ib + "__fullscreen-icon", _b = ib + "__error", ac = ib + "__loading", bc = ib + "__loaded", cc = bc + "--full", dc = bc + "--img", ec = ib + "__grabbing", fc = ib + "__img", gc = fc + "--full", hc = ib + "__dot", ic = ib + "__thumb", jc = ic + "-border", kc = ib + "__html", lc = ib + "__video", mc = lc + "-play", nc = lc + "-close", oc = ib + "__caption", pc = ib + "__caption__wrap", qc = ib + "__spinner", rc = '" tabindex="0" role="button', sc = d && d.fn.jquery.split(".");
    if (!sc || sc[0] < 1 || 1 == sc[0] && sc[1] < 8)throw"Gallery requires jQuery 1.8 or later and will not run without it.";
    ...
    jQuery.Gallery = function (a, e) {
        ...
        function Pb(a, b, c, f, g, h) {
            cb(a, b, function (a, i, j, k, l, m) {
                ...
                function o() {
                    t.remove(), d.Gallery.cache[w] = "error", j.html && "stage" === b || !y || y === w ? (!w || j.html || r ? "stage" === b && (k.trigger("f:load").removeClass(ac + " " + _b).addClass(bc), n("load"), fb()) : (k.trigger("f:error").removeClass(ac).addClass(_b), n("error")), m.state = "error", !(zd > 1 && yd[i] === j) || j.html || j.deleted || j.video || r || (j.deleted = !0, ie.splice(i, 1))) : (j[v] = w = y, Pb([i], b, c, f, g, !0))
                }

                function p() {
                    d.Gallery.measures[w] = u.measures = d.Gallery.measures[w] || {
                            width: s.width,
                            height: s.height,
                            ratio: s.width / s.height
                        }, fb(u.measures.width, u.measures.height, u.measures.ratio, i), t.off("load error").addClass(fc + (r ? " " + gc : "")).prependTo(k), I(t, (d.isFunction(c) ? c() : c) || Le, f || j.fit || e.fit, g || j.position || e.position), d.Gallery.cache[w] = m.state = "loaded", setTimeout(function () {
                ...
                if (k) {
                    ...
                    if (!m.$img || h || r) {
                        ...
                        d.Gallery.cache[w] ? !function z() {
                            "error" === d.Gallery.cache[w] ? o() : "loaded" === d.Gallery.cache[w] ? setTimeout(q, 0) : setTimeout(z, 100)
                        }() : (d.Gallery.cache[w] = "*", t.on("load", q).on("error", o)), m.state = "", s.src = w
                    }
                }
            })
        }
        ...
        qe[Xc] = d(N(yb)), qe[Zc] = d(N(Mb + " " + Ob + rc, N(ic))), qe[Yc] = d(N(Mb + " " + Nb + rc, N(hc))), Qe[Xc] = [], Qe[Zc] = [], Qe[Yc] = [], Re[Xc] = {}, qe.addClass(Ic ? mb : lb).toggleClass(qb, !e.controlsonstart), ne.gallery = this, ie.startAutoplay = function (a) {
            ...
            return "object" == typeof b && a.videoReady && (Rd && ie.fullScreen && ie.cancelFullScreen(), G(function () {
                ...
                c === Je && (a.$video = a.$video || d(d.Gallery.jst.video(b)), a.$video.appendTo(a[Xc]), qe.addClass(nb), Cd = a.$video, o(), we.blur(), De.blur(), fd("loadvideo"))
            })), this
    ...
    }, d.fn.gallery = function (b) {
        return this.each(function () {
            var c = this, e = d(this), f = e.data(), g = f.gallery;
            g ? g.setOptions(b, !0) : G(function () {
                return !E(c)
            }, function () {
                f.urtext = e.html(), new d.Gallery(e, d.extend({}, cd, a.galleryDefaults, b, f))
            })
        })
    }, d.Gallery.instances = [], d.Gallery.cache = {}, d.Gallery.measures = {}, d = d || {}, d.Gallery = d.Gallery || {}, d.Gallery.jst = d.Gallery.jst || {}, d.Gallery.jst.style = function (a) {
        {
            var b, c = "";
            tc.escape
        }
        return c += ".gallery" + (null == (b = a.s) ? "" : b) + " .gallery__nav--thumbs .gallery__nav__frame{\npadding:" + (null == (b = a.m) ? "" : b) + "px;\nheight:" + (null == (b = a.h) ? "" : b) + "px}\n.gallery" + (null == (b = a.s) ? "" : b) + " .gallery__thumb-border{\nheight:" + (null == (b = a.h - a.b * (a.q ? 0 : 2)) ? "" : b) + "px;\nborder-width:" + (null == (b = a.b) ? "" : b) + "px;\nmargin-top:" + (null == (b = a.m) ? "" : b) + "px}"
    }, d.Gallery.jst.video = function (a) {
        function b() {
            c += d.call(arguments, "")
        }

        var c = "", d = (tc.escape, Array.prototype.join);
        return c += '<div class="gallery__video"><iframe src="', b(("youtube" == a.type ? a.p + "youtube.com/embed/" + a.id + "?autoplay=1" : "vimeo" == a.type ? a.p + "player.vimeo.com/video/" + a.id + "?autoplay=1&badge=0" : a.id) + (a.s && "custom" != a.type ? "&" + a.s : "")), c += '" frameborder="0" allowfullscreen></iframe></div>\n'
    }, d(function () {
        d("." + ib + ':not([data-auto="false"])').gallery()
    })
