...
">
    ...
    <div id="body" style="padding: 25px">
        ...
        <p><em>В случае, если Вы не производили никаких действий на сайте ON!, просто проигнорируйте это письмо, но
                имейте ввиду, что Ваш Email использовался для регистрации. Более подробную информацию Вы можете узнать
                на сайте, сообщив об этом в техподдержку или ответив на это письмо.</em></p>
    </div>
